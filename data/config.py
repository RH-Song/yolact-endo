...
dataset_base = Config({
    ...
    'train_images': './data/my_coco/train/',
    'train_info':   'path_to_annotation_file',

    # Validation images and annotations.
    'valid_images': './data/my_coco/val/',
...
miccai_no6_dataset = dataset_base.copy({
    'name': 'miccai dataset',
    
    'train_info': './data/my_coco_miccai6/annotations/train.json',
    'valid_info': './data/my_coco_miccai6/annotations/val.json',

    'label_map': COCO_LABEL_MAP
})

miccai_dataset = dataset_base.copy({
    'name': 'miccai dataset',
    
    'train_info': './data/my_coco_miccai/annotations/train.json',
    'valid_info': './data/my_coco_miccai/annotations/val.json',

    'label_map': COCO_LABEL_MAP
})

brain_dataset = dataset_base.copy({
    'name': 'brain dataset',
    
    'train_info': './data/my_coco_brain/annotations/train.json',
    'valid_info': './data/my_coco_brain/annotations/val.json',

    'label_map': COCO_LABEL_MAP
})

aug_brain_dataset = dataset_base.copy({
    'name': 'aug brain dataset',
    
    'train_info': './data/my_coco_aug_brain/annotations/train.json',
    'valid_info': './data/my_coco_aug_brain/annotations/val.json',
...
coco2014_dataset = dataset_base.copy({
    ...
    'train_info': './data/my_coco/annotations/train.json',
    'valid_info': './data/my_coco/annotations/val.json',

    'label_map': COCO_LABEL_MAP
})

coco2014_testdev_dataset = dataset_base.copy({
    'name': 'COCO 2014 Test-Dev',
...
coco_base_config = Config({
    ...
    # 'nms_thresh': 0.65,
    # 'nms_thresh': 0.4, # for diou
    'nms_thresh': 0.2, # for soft-nms
